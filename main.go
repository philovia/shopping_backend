...
func (r *Repository) GetBooks(context *fiber.Ctx) error {
	...
	// bookModels := []models.AllBooks{} //sir dan
	...
	//sir Dan
	// if err := r.DB.Debug().Raw("SELECT * FROM books").Scan(&bookModels); err != nil {
	// 	context.Status(http.StatusBadRequest).JSON(
	// 		&fiber.Map{"message": "could not get books"})
	// 	return nil
	// }
	...
	return context.JSON(bookModels)
...
func (r *Repository) SetupRoutes(app *fiber.App) {
	api := app.Group("/api")
	api.Post("/crate_books", r.CreateBook)
